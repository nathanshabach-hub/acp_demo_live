...
class EventcategoriesController extends AppController {
    ...
    protected array $paginate = ['limit' => 50, 'order' => ['Eventcategories.name' => 'asc']];
    ...
    public function index() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->request->getData('Eventcategories.keyword') !== null && $this->request->getData('Eventcategories.keyword') != '') {
        ...
        $query = $this->Eventcategories->find()
            ->where($condition);
        $this->paginate = ['limit' => 20];
        $this->set('eventcategories', $this->paginate($query));
    ...
    public function add() {
        ...
        $eventcategories = $this->Eventcategories->newEmptyEntity();
        if ($this->request->is('post')) {
