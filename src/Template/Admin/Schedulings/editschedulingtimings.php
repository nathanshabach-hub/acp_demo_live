...
{
	$currentStartTime= safe_date("h:i A", $schedulingtimingsD->start_time);
}

if(!empty($schedulingtimingsD->finish_time) && isset($schedulingtimingsD->finish_time))
{
	$currentFinishTime= safe_date("h:i A", $schedulingtimingsD->finish_time);
}
            ...
            <?php echo $this->Form->create($schedulings, ['id'=>'schedulingWizardForm', 'type' => 'file', 'autocomplete' => 'off']); ?>
                <div class="form-horizontal">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10" style="padding-top:6px;">
							<?php echo $schedulingtimingsD->start_time!=NULL ? safe_date("H:i A", $schedulingtimingsD->start_time) : ''; ?>
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10" style="padding-top:6px;">
							<?php echo $schedulingtimingsD->finish_time!=NULL ? safe_date("H:i A", $schedulingtimingsD->finish_time) : ''; ?>
                      </div>
                    </div>
