...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
            Manage Convention Registrations Supervisors :: <?php echo (isset($CRDetails->Conventions) ? $CRDetails->Conventions->name : ''); ?>
      </h1>
      <ol class="breadcrumb">
          ...
          <li class="active"> Convention Registrations Supervisors List </li>
      </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search" style="display:none;">
                <?php echo $this->Form->create(Null, ['id'=>'adminSearch']); ?>
                    <div class="form-group align_box dtpickr_inputs">
                       ...
                       <span class="hint">
                           <?php echo $this->Form->select('Conventionregistrationteachers.season_year', $seasonsDD, ['id' => 'season_year', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off', 'empty' => 'All Seasons', 'style' => 'margin-bottom:2px;']); ?>
							<script>
								$(document).ready(function() {
									//$('#season_year').select2();
								});
            ...
            <div class="m_content" id="listID">
                <?php echo $this->element("Admin/Conventionregistrations/teachers"); ?>
            </div>
