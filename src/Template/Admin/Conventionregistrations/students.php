...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
            Manage Convention Registrations Students :: <?php echo (isset($CRDetails->Conventions) ? $CRDetails->Conventions->name : ''); ?>
      </h1>
      <ol class="breadcrumb">
          ...
          <li class="active"> Convention Registrations Students List </li>
      </ol>
    </section>
            ...
            <div class="admin_search" style="display:none;">
                <?php echo $this->Form->create(Null, ['id'=>'adminSearch']); ?>
                    <div class="form-group align_box dtpickr_inputs">
                       ...
                       <span class="hint">
                           <?php echo $this->Form->select('Conventionregistrationstudents.convention_id', $conventionsDD, ['id' => 'convention_id', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off', 'empty' => 'All Conventions', 'style' => 'margin-bottom:2px;']); ?>
							<script>
					   ...
					   <span class="hint">
                           <?php echo $this->Form->select('Conventionregistrationstudents.season_year', $seasonsDD, ['id' => 'season_year', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off', 'empty' => 'All Seasons', 'style' => 'margin-bottom:2px;']); ?>
							<script>
								$(document).ready(function() {
									//$('#season_year').select2();
								});
