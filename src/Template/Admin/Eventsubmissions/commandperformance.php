...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		  ...
		  <li class=""> Judge Evaluations </li>
          <li class="active">Command Performance </li>
      </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search" style="display:none;">
                <?php echo $this->Form->create(Null, ['id'=>'adminSearch']); ?>
                    <div class="form-group align_box dtpickr_inputs">
                       ...
                       <span class="hint">
                           <?php echo $this->Form->select('Eventsubmissions.convention_id', $conventionsDD, ['id' => 'convention_id', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off', 'empty' => 'All Conventions', 'style' => 'margin-bottom:2px;']); ?>
							<script>
					   ...
					   <span class="hint">
                           <?php echo $this->Form->select('Eventsubmissions.season_year', $seasonsDD, ['id' => 'season_year', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off', 'empty' => 'All Seasons', 'style' => 'margin-bottom:2px;']); ?>
							<script>
								$(document).ready(function() {
									//$('#season_year').select2();
								});
            ...
            <div class="m_content" id="listID">
                <?php echo $this->element("Admin/Eventsubmissions/commandperformance"); ?>
            </div>
