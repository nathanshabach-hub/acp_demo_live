...
<?php foreach ($chunk as $datarecord): ?>
    <div class="name-card">
        <h4><?php echo htmlspecialchars($datarecord->Students['first_name'] . ' ' . $datarecord->Students['last_name']); ?></h4>
...
<?php endforeach; ?>
<?php
// Fill remaining slots so the grid has 12 cells (keeps borders intact)
