                                ...
                                <td>
                                    <?php if ($hasOpen && $hasEnd): ?>
                                        <span style="font-size:12px;">
                                            <?php echo safe_date('d M', $cs->registration_start_date); ?>
                                            &rarr;
                                            <?php echo safe_date('d M Y', $cs->registration_end_date); ?>
                                        </span>
                                    <?php else: ?>
                    ...
                    <table class="vc-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo !empty($reg->created) ? safe_date('d M Y', $reg->created) : '—'; ?></td>
                                <td>
                                    <?php if ($attCount > 0): ?>
