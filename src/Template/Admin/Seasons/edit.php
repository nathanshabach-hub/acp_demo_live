...
{
	$seasons->registration_start_date = safe_date("Y-m-d", $seasons->registration_start_date);
}

if(!empty($seasons->registration_end_date) && $seasons->registration_end_date != NULL)
{
	$seasons->registration_end_date = safe_date("Y-m-d", $seasons->registration_end_date);
}
?>
