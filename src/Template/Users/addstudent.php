...
<style>
	.add-student-header a,
	.add-student-actions a {
		color: #343a3d !important;
	}

	.add-student-actions a:hover {
		color: #fff !important;
	}
</style>
<div class="container-fluid p-0">
	<div class="row">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<div class="d-flex align-items-center justify-content-between mt-4 mb-3 add-student-header">
			...
			<div class="card shadow-sm border-0 mb-5" style="border-radius: 12px; overflow: hidden;">
				...
				<div class="card-body p-4">
					<?php echo $this->Form->create($users, ['id' => 'addstudent', 'type' => 'file']); ?>
					...
					<div class="d-flex gap-2 add-student-actions">
