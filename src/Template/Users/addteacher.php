...
<style>
	.add-teacher-header a,
	.add-teacher-actions a {
		color: #343a3d !important;
	}

	.add-teacher-actions a:hover {
		color: #fff !important;
	}
</style>
<div class="container-fluid p-0">
	<div class="row">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<div class="d-flex align-items-center justify-content-between mt-4 mb-3 add-teacher-header">
			...
			<div class="card shadow-sm border-0 mb-5" style="border-radius: 12px; overflow: hidden;">
				<div class="card-header py-3" style="background: linear-gradient(135deg, #1c2452, #78A4C8); border: none;">
					<h5 class="mb-0" style="color: #fff; font-size: 16px;">
						<i class="fa fa-user-plus me-2"></i> Supervisor Information
					</h5>
				</div>
				<div class="card-body p-4">
					<?php echo $this->Form->create($users, ['id' => 'addteacher', 'type' => 'file']); ?>
					...
					<div class="row g-3 mb-4">
						<div class="col-md-4">
							<label class="form-label fw-semibold">Email Address <span style="color:#d00;">*</span></label>
					...
					<div class="d-flex gap-2 add-teacher-actions">
