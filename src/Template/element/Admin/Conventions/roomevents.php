...
$slugConventionSeason = $slug_convention_season ?? null;
?>
        ...
        <section id="no-more-tables" class="lstng-section">
            <div class="topn">
                ...
                <div class="topn_right ajshort" id="pagingLinks" align="right">
                    <?php 
                        $this->Paginator->options(array('update' => '#listID', 'url' => ['controller'=>'conventions', 'action'=>'roomevents', $slugConventionSeason]));
                    ...
                    <tbody>
						...
						?>
                            ...
                            <tr>
								...
								<?php
                                echo $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'conventions', 'action' => 'editroomevents',$datarecord->slug,$slugConventionSeason], [ 'escape' => false, 'title' => 'Edit', 'class'=>'btn btn-primary btn-xs']);
								
                                echo $this->Html->link('<i class="fa fa-trash-o"></i>', ['controller' => 'conventions', 'action' => 'deleteroomevents',$datarecord->slug,$slugConventionSeason], [ 'escape' => false, 'title' => 'Delete', 'class'=>'btn btn-danger btn-xs action-list delete-list', 'confirm' => 'Are you sure you want to Delete ?']);
								?>
								</td>
                            </tr>
                        <?php } ?>
