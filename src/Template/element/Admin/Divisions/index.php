        ...
        <section id="no-more-tables" class="lstng-section">
            <div class="topn">
                ...
                <div class="topn_right ajshort" id="pagingLinks" align="right">
                    <?php 
                        $this->Paginator->options(array('update' => '#listID', 'url' => ['controller'=>'divisions', 'action'=>'index', $separator]));
                    ...
                    <tbody>
                        <?php foreach ($divisions as $datarecord) { ?>
                            ...
                            <tr>
								...
								<td data-title="Division Name">
								<?php
								if($datarecord->parent_division_id>0)
								{
									$parentDiv = $this->Divisions->find()->where(['Divisions.id' => $datarecord->parent_division_id])->first();
									echo $parentDiv->name.'-->';
								}
								echo $datarecord->name;
