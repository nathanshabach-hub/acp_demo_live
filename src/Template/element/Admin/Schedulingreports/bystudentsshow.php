            ...
            <div class="tbl-resp-listing">
                <table id="report_by_school_student" class="table table-bordered table-striped table-condensed cf">
					...
					foreach ($schedulingTimingsList as $datarecord)
					{
						...
						$arrSch['start_time']	= $datarecord->start_time!=NULL ? safe_date("h:i A", $datarecord->start_time) : '';
					...
					if($studentGroups)
					{
						...
						{ 
							...
							foreach($schedulingStGrp as $schstudgrprec)
							{
								...
								$arrSch['start_time']	= $schstudgrprec->start_time!=NULL ? safe_date("h:i A", $schstudgrprec->start_time) : '';
