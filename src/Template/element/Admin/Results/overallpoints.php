...
<?php //if (!$conventionseasonevents->isEmpty()) { ?> 
    <div class="panel-body">
        ...
        <section id="no-more-tables" class="lstng-section">
            <div class="topn">
                <div class="topn_left"> View Overall Points
				</div>  
            </div>   
            ...
            <div class="tbl-resp-listing">
                <table id="results_table" class="table table-bordered table-striped table-condensed cf">
                    ...
                    <tbody>
                        <?php
						foreach($arrAllResults as $student_id => $pointsS)
						{
						...
						?> 
                            <tr>
                                ...
                                <td data-title="24/7 Certificate">
									<?php
									//if(in_array($student_id,$maxKeys))
									//{
										echo $this->Html->link('<i class="fa fa-file-pdf-o"></i>', ['controller' => 'results', 'action' => 'certificate24by7pdf',$slug_convention_season,$studentD->slug,$pointsS], [ 'escape' => false, 'title' => 'Generate 24/7 Certificate', 'target'=>'_blank']);
									//}
									?>
								</td>
                            </tr>
