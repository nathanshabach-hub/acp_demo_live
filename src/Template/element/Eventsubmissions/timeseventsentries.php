            ...
            <div class="tbl-resp-listing">
                <table id="group_events_table" class="table table-striped table-bordered" style="width:100%">
					...
					<tbody>
						...
						if($getJudgeEvalData->time_score != NULL && !empty($getJudgeEvalData->time_score))
						{
						...
						if($getJudgeEvalData->withdraw_yes_no == 1)
							...
							$checkedWithdr = '';
						?>
						<input type="text" name="time_score_<?php echo $cntrES; ?>" id="time_score_<?php echo $cntrES; ?>" value="<?php echo $formattedTime; ?>" />
						</td>
