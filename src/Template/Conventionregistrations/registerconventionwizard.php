                ...
                <div class="conf-hero">
                    ...
                    <div class="conf-hero-body">
                        ...
                        <div class="hero-meta">
                            ...
                            <span><i class="fa fa-clock-o"></i> <?php echo date('d M Y', strtotime($convSeasonD->registration_start_date)); ?> – <?php echo date('d M Y', strtotime($convSeasonD->registration_end_date)); ?></span>
                            <?php endif; ?>
                            <?php if ($regFee): ?>
                    ...
                    <div class="wiz-card">
                        ...
                        <div class="wiz-card-body">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-val">
                                    <?php echo date('D, d M Y', strtotime($convSeasonD->registration_start_date)); ?>
                                    &nbsp;&rarr;&nbsp;
                                    <?php echo date('D, d M Y', strtotime($convSeasonD->registration_end_date)); ?>
                                    <?php
                                    $now = time();
